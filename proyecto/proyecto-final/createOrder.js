...
const params = {
    ...
    QueueUrl: 'https://sqs.us-east-1.amazonaws.com/686455697581/order-queue' // Reemplaza con tu URL de la cola
};
...
try {
    ...
    const emailParams = {
    Destination: {
        ToAddresses: ['hernandezjhon795@gmail.com'] // Reemplaza con la dirección de correo electrónico del cliente
    },
    Message: {
        Body: {
        Text: {
      ...
      Source: 'munozmariafernanda917@gmail.com' // Reemplaza con tu dirección de correo electrónico
    };
